...
const supabaseKey = window.APP_CONFIG?.supabaseAnonKey || window.APP_CONFIG?.supabasePublishableKey || "";
const canUseSupabase = Boolean(supabaseUrl && supabaseKey && window.supabase?.createClient);
const supabaseClient = canUseSupabase ? window.supabase.createClient(supabaseUrl, supabaseKey) : null;
